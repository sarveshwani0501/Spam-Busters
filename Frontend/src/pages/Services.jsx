...
const Services = () => {
  ...
  <form className="w-[500px]  p-6 rounded-xl shadow-lg border border-gray-200 bg-gradient-to-r from-cyan-400 to-blue-600">
    ...
    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 bg-gray-300 text-center">
      <label for="file-upload" className="cursor-pointer">
        <div className="flex flex-col items-center space-y-2">
          <button type="button" className="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700">
            📂 Choose files
          </button>
    ...
    <button type="submit" className="w-full bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-3 rounded-lg mt-6 transition duration-300">
      Submit
    </button>
